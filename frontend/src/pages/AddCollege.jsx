...
const AddCollege = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/admin/dashboard', { state: { message: 'College added successfully!' } });
    } catch (err) {
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg px-8 py-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="md:col-span-2">
              <label htmlFor="images" className="block text-sm font-medium text-gray-700 mb-2">College Images (max 5)</label>
              ...
              >
                <div className="space-y-1 text-center">
                  ...
                  <p className="text-xs text-gray-500">PNG, JPG, JPEG up to 5 files</p>
                </div>
              </div>
